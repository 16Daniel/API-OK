using biz.bd1.Repository.Stock;
...
{
    public class StockRepository : GenericRepository<biz.bd1.Entities.Stock>, IStockRepository
    {
        public StockRepository(BD1Context context) : base(context)
        {

        }
        public List<biz.bd1.Models.StockDto> GetStock(int id_sucursal)
        {
            List<biz.bd1.Models.StockDto> _stock = new List<biz.bd1.Models.StockDto>();
            List<biz.bd1.Models.StockDto> _stock2 = new List<biz.bd1.Models.StockDto>();
            ...
            if (serie != null)
            {
                _stock = _context.Stocks
                    ...
                    art => art.Codarticulo,
                    stk => stk.Codarticulo,
                    (art, stk) => new biz.bd1.Models.StockDto()
                    {
        ...
        public List<biz.bd1.Models.StockDto> GetStockV(int id_sucursal)
        {
            List<biz.bd1.Models.StockDto> _stock = new List<biz.bd1.Models.StockDto>();
            List<biz.bd1.Models.StockDto> _stock2 = new List<biz.bd1.Models.StockDto>();
            ...
            if (serie != null)
            {
                ...
                //_stock = _context.Stocks
                //        .Join(_context.Moviments,
                //        art => art.Codarticulo,
                //        stk => stk.Codarticulo,
                //        (art, stk) => new biz.bd1.Models.StockDto()
                //        {
                //          Codarticulo = stk.Codarticulo,
                //          Codalmacen = stk.Codalmacenorigen,
                //          Ultfecha = stk.Fecha,
                //        })
                //        .Join(_context.Articuloscamposlibres,
                //        art => art.Codarticulo,
                ...
                //        Unidadmedida = art.Unidadmedida,
                //        Ultfecha = art.Ultfecha,
                //        }).Where(s => s.Ultfecha == DateTime.Now.Date && s.Codalmacen == serie && s.Regulariza == "T").ToList();
        ...
        public biz.bd1.Models.StockDto UpdateStock(int codArticulo, string codAlmacen, double cantidad)
        {
            ...
            if (__stock != null)
            {
              ...
              if (tablaInv != DateTime.Now.Date) {
                ...
                biz.bd1.Entities.Moviment _moviment = new biz.bd1.Entities.Moviment();
        ...
        public biz.bd1.Models.StockDto UpdateStockV(int codArticulo, string codAlmacen, double cantidad)
        {
            biz.bd1.Models.StockDto _stock = new biz.bd1.Models.StockDto();
            // FECHA DE INVENTARIOS
